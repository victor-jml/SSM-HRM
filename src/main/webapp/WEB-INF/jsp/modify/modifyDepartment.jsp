            ...
            if (obj.event === 'del') {
                layer.confirm('确定删除此部门吗？', function (index) {
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        url: "${request}/employee/deleteOneDep.html",
                        success: function (data) {
                            if (data.data == "deleteSuccess") {
                                layer.msg('删除成功', {
                                    icon: 1
                ...
                layer.open({
                    ...
                    success: function (layero, index) {
                        ...
                        othis.find('input[name="depid"]').val(data.depid);
                        othis.find('input[name="depname"]').val(data.depname);
                        othis.find('input[name="depleader"]').val(data.depleader);
