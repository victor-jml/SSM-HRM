...
<script>
    layui.config({
        ...
        form.on('submit(LAY-user-login-submit)', function (obj) {
            ...
            $.ajax({
                type: 'post'
                , url: '${request}/login/loginCheck.html' //实际使用请改成服务端真实接口
                , data: {'name': field.username, 'password': field.password, 'remember': field.remember}
                , success: function (res) {
                    ...
                    if (res.code == 100) {
                        ...
                        layer.msg('登入成功', {
                            ...
                            location.href = '${request}/login/toMain.html'; //后台主页
                        });
